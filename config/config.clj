  ...
  {:bwertr-app
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"bwertr_app/rendering.js"]}}
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/bwertr-app-dev.html"
                            :name "Development"
                            :out-file "bwertr-app-dev.js"
                            :main 'bwertr-app.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :output-root :tools-public
                      :template "tooling.html"}
              :production {:uri "/bwertr-app.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "bwertr-app.js"
                           :main 'bwertr-app.start
                           :order 5}}}})
