(ns bwertr-app.start
  (:require [io.pedestal.app.protocols :as p]
            ...
            [bwertr-app.behavior :as behavior]
            [bwertr-app.rendering :as rendering]))
...
(defn create-app [render-config]
  (let [;; Build the application described in the map
        ...
        app (app/build behavior/bwertr-app)
        ...
        ;;
        ;; The file, app/src/bwertr_app/rendering.cljs contains
    ...
    (p/put-message (:input app) {msg/type :init msg/topic [:ratings] :ratings [1 7 10]})
