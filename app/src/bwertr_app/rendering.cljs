(ns bwertr-app.rendering
  (:require [domina :as dom]
            [io.pedestal.app.render.push :as render]
            [io.pedestal.app.render.push.templates :as templates]
            [io.pedestal.app.render.push.handlers.automatic :as d])
  (:require-macros [bwertr-app.html-templates :as html-templates]))

;; Load templates.

(def templates (html-templates/bwertr-app-templates))
...
(defn render-page [renderer [_ path] transmitter]
  (let [;; The renderer that we are using here helps us map changes to
        ...
        ;; Get the dynamic template named :bwertr-app-page
        ...
        html (templates/add-template renderer path (:bwertr-app-page templates))]
